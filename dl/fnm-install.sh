...
download_fnm() {
  if [ "$USE_HOMEBREW" = "true" ]; then
    ...
    if [ "$RELEASE" = "latest" ]; then
      URL="${FNM_BASE_URL:-https://github.com}/Schniz/fnm/releases/latest/download/$FILENAME.zip"
    else
      URL="${FNM_BASE_URL:-https://github.com}/Schniz/fnm/releases/download/$RELEASE/$FILENAME.zip"
    fi
